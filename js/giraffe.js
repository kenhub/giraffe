...
generateDataURL = function(targets, annotator_target, max_data_points) {
  ...
  return "" + graphite_url + "/render?from=-" + period + "minutes&" + data_targets + annotator_target + "&maxDataPoints=" + max_data_points + "&cacheTimeout=" + cacheTimeout + "&format=json&jsonp=?";
};
